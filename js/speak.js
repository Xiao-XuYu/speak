import{b as x,c as g,k as u}from"./chunk-IUFCCRW5.js";import{b,d as y,h as _}from"./chunk-UVODTIDZ.js";import{a as p,b as h}from"./chunk-IGCIOYLB.js";var f="speak-state",m="speak-auto-all",k=`\u4F60\u662F\u6587\u672C\u5206\u6BB5\u52A9\u624B\u3002\u628A\u7528\u6237\u7C98\u8D34\u7684\u957F\u6587\u672C\u6309\u8BED\u4E49 / \u573A\u666F / \u6BB5\u843D\u5207\u6210\u82E5\u5E72\u4E2A\u9002\u5408\u6717\u8BFB\u7684\u5C0F\u6BB5\u3002
\u8981\u6C42:
...
\u53EA\u8F93\u51FA JSON,\u683C\u5F0F: {"segments": ["\u7B2C1\u6BB5\u539F\u6587...", "\u7B2C2\u6BB5\u539F\u6587...", ...]}`,d={eye:'<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>',clipboard:'<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/></svg>',sparkles:'<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l1.6 4.4L18 8l-4.4 1.6L12 14l-1.6-4.4L6 8l4.4-1.6L12 2zM5 14l.8 2.2L8 17l-2.2.8L5 20l-.8-2.2L2 17l2.2-.8L5 14zm14 0l.8 2.2L22 17l-2.2.8L19 20l-.8-2.2L16 17l2.2-.8L19 14z"/></svg>',save:'<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"/><polyline points="17 21 17 13 7 13 7 21"/><polyline points="7 3 7 8 15 8"/></svg>'},S={title:"\u6717\u8BFB",mount(t){let e=h.get(f,{text:"",segments:[]}),s=h.get(m,!1)===!0;this._root=t,this._text=e.text||"",this._segments=Array.isArray(e.segments)?e.segments:[],this._playingIndex=-1,this._lastIndex=-1,this._pausedIndex=-1,this._userScrollingUntil=0,t.innerHTML=`
      <div class="flex flex-col h-full">
        ...
        <div class="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 px-3 sm:px-4 py-2.5 sm:py-3 flex flex-wrap items-center gap-2 sm:gap-3">
          ...
          <button id="save-file" type="button"
                  class="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-md border border-slate-300 dark:border-slate-600 hover:bg-slate-100 dark:hover:bg-slate-700 active:scale-95 transition text-xs sm:text-sm">
            ${d.save}<span>\u4FDD\u5B58\u5230\u6587\u4EF6</span>
          </button>
        ...
        <dialog id="save-dlg" class="p-0 bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-100 backdrop:bg-black/40 max-w-[480px] w-[min(480px,calc(100vw-32px))] border border-slate-200 dark:border-slate-700">
          <form method="dialog" class="flex flex-col">
            <header class="flex items-center px-4 py-3 border-b border-slate-200 dark:border-slate-700 shrink-0">
              <strong class="text-sm">\u4FDD\u5B58\u5230\u6587\u4EF6</strong>
              <div class="flex-1"></div>
              <button type="button" data-action="close" class="px-2 py-1 rounded-md text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-700" aria-label="\u5173\u95ED">\u2715</button>
            </header>
            <div class="p-4 flex flex-col gap-3">
              <p class="text-xs text-slate-500 -mt-1">\u628A\u5F53\u524D\u6587\u672C\u548C\u5206\u6BB5\u5B58\u5230 IndexedDB\u3002\u540E\u7EED\u53EF\u5728\u300C\u6587\u4EF6\u7BA1\u7406\u300D\u9875\u9762\u67E5\u770B\u3001\u52A0\u8F7D\u6216\u5220\u9664\u3002</p>
              <label class="flex flex-col gap-1">
                <span class="text-xs text-slate-600 dark:text-slate-300">\u6587\u4EF6\u6807\u9898</span>
                <input id="save-title" type="text" class="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-md focus:border-blue-500 focus:outline-none bg-white dark:bg-slate-900 text-sm" placeholder="\u672A\u547D\u540D\u6587\u4EF6">
              </label>
    ...
    `).join(""),t.style.paddingTop="4rem",t.style.paddingBottom="4rem",t.querySelectorAll("[data-lyric-index]").forEach(s=>{s.addEventListener("click",()=>{let a=Number(s.dataset.lyricIndex);this._pausedIndex=-1,this._playFrom(a)})}),e.scrollTop=0,this._playingIndex=-1,this._lastIndex=-1,this._hideNowPlaying(),this._emitPlaybackState()},_markPlaying(t){this._playingIndex=t,t>=0&&(this._lastIndex=t);let e=this._root.querySelector("#lyrics-scroller"),a=this._root.querySelector("#lyrics-list").querySelectorAll("[data-lyric-index]"),l=["lyric-active","aria-current","text-blue-600","dark:text-blue-300","font-bold","text-2xl","sm:text-3xl"],n=["text-slate-500","dark:text-slate-400","text-base","sm:text-lg"];if(a.forEach(r=>{r.classList.remove(...l),r.classList.add(...n),r.removeAttribute("aria-current")}),t>=0&&a[t]){let r=a[t];if(r.classList.remove(...n),r.classList.add(...l),r.setAttribute("aria-current","true"),this._showNowPlaying(t),Date.now()<this._userScrollingUntil){this._emitPlaybackState();return}try{r.scrollIntoView({block:"center",behavior:"smooth"})}catch{let i=e.getBoundingClientRect(),o=r.getBoundingClientRect(),c=e.scrollTop+(o.top-i.top)-i.height/2+o.height/2;e.scrollTo({top:c,behavior:"smooth"})}}else this._hideNowPlaying();this._emitPlaybackState()},_showNowPlaying(t){let e=this._root?.querySelector("#now-playing");e&&(e.textContent=`\u6B63\u5728\u6717\u8BFB ${t+1} / ${this._segments.length}`,e.classList.remove("hidden"))},_hideNowPlaying(){let t=this._root?.querySelector("#now-playing");t&&(t.classList.add("hidden"),t.textContent="")},async _playFull(){let t=(this._text||"").trim();if(!t){this._setAiStatus("\u6CA1\u6709\u53EF\u6717\u8BFB\u7684\u6587\u672C","err");return}this._pausedIndex=-1,await u.speak({text:t},{onStart:()=>{this._setAiStatus("\u6B63\u5728\u6717\u8BFB\u5168\u6587...","info"),this._emitPlaybackState()},onEnd:()=>{this._setAiStatus("\u5168\u6587\u6717\u8BFB\u5B8C\u6BD5","ok"),this._emitPlaybackState()},onError:e=>{this._setAiStatus("\u6717\u8BFB\u5931\u8D25:"+(e?.message||e),"err"),this._emitPlaybackState()}})},async _playFrom(t){if(this._segments.length===0)return;let e=Math.max(0,Math.min(t,this._segments.length-1)),s=this._root.querySelector("#auto-all").checked===!0;this._stopAll({silent:!0}),s?await this._playRange(e,this._segments.length-1):await this._playRange(e,e)},async _playRange(t,e){this._userStopped=!1;for(let s=t;s<=e&&!this._userStopped;s++){this._markPlaying(s);let a=this._segments[s]||"",l=A(a),n=l==="zh"?"\u4E2D":"EN";if(this._setAiStatus(`\u6B63\u5728\u6717\u8BFB\u7B2C ${s+1} / ${this._segments.length} \u6BB5 (${n})...`,"info"),await u.speak({text:a,lang:l},{onStart:()=>{},onEnd:()=>{},onError:r=>{this._setAiStatus(`\u7B2C ${s+1} \u6BB5\u6717\u8BFB\u5931\u8D25:${r?.message||r}`,"err"),this._userStopped=!0}}),t===e||this._userStopped)break}this._markPlaying(-1),this._userStopped||this._setAiStatus(t===e?"\u64AD\u653E\u5B8C\u6BD5":`\u5DF2\u6309\u987A\u5E8F\u64AD\u653E\u7B2C ${t+1}~${e+1} \u6BB5`,"ok")},_stopAll({silent:t=!1}={}){this._userStopped=!0,u.stop(),this._markPlaying(-1),t||this._setAiStatus("\u5DF2\u505C\u6B62","info"),this._emitPlaybackState()},async _aiSplit(){let t=(this._text||"").trim();if(!t){this._setAiStatus("\u6CA1\u6709\u53EF\u62C6\u5206\u7684\u6587\u672C","err");return}if(!x.isConfigured()){this._setAiStatus("\u8BF7\u5148\u5728 \u2699 \u8BBE\u7F6E \u2192 MiniMax AI \u914D\u7F6E \u586B\u5199 API Key","err");return}let e=this._root.querySelector("#ai-split"),s=e.innerHTML;e.disabled=!0,e.innerHTML=`${d.sparkles}<span>\u62C6\u5206\u4E2D...</span>`,this._setAiStatus("\u6B63\u5728\u8BF7\u6C42 AI \u62C6\u5206...","info");try{let a=await this._callAiSplit(t);if(!Array.isArray(a)||a.length===0)throw new Error("AI \u672A\u8FD4\u56DE\u6709\u6548\u5206\u6BB5");this._stopAll({silent:!0}),this._segments=a.map(l=>String(l).trim()).filter(Boolean),this._saveState(),this._renderLyrics(),this._updateMeta(),this._setAiStatus(`\u62C6\u5206\u5B8C\u6210,\u5171 ${this._segments.length} \u6BB5`,"ok")}catch(a){this._setAiStatus("AI \u62C6\u5206\u5931\u8D25,\u5DF2\u964D\u7EA7\u4E3A\u672C\u5730\u5207\u5206:"+(a?.message||a),"err");let l=g.split(t);this._stopAll({silent:!0}),this._segments=l,this._saveState(),this._renderLyrics(),this._updateMeta()}finally{e.disabled=!1,e.innerHTML=s}},async _callAiSplit(t){let e=x.get(),s=e.baseUrl.replace(/\/+$/,"")+"/chat/completions",a=`\u3010\u5F85\u62C6\u5206\u6587\u672C\u3011
${t.slice(0,12e3)}`,l=new AbortController,n=setTimeout(()=>l.abort(),6e4),r;try{r=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${e.apiKey}`},body:JSON.stringify({model:x.getEffectiveModel(),messages:[{role:"system",content:k},{role:"user",content:a}],temperature:.2,stream:!1}),signal:l.signal})}catch(c){throw c?.name==="AbortError"?new Error("\u8BF7\u6C42\u8D85\u65F6 (60s),\u8BF7\u68C0\u67E5\u7F51\u7EDC\u6216 AI \u670D\u52A1"):c instanceof TypeError?new Error(`\u7F51\u7EDC\u9519\u8BEF:${c.message} (\u53EF\u80FD\u662F CORS / \u8DE8\u57DF\u88AB\u62E6)`):c}finally{clearTimeout(n)}if(!r.ok){let c=await r.text().catch(()=>r.statusText);throw new Error(`HTTP ${r.status} \u2014 ${c.slice(0,200)}`)}let o=(await r.json().catch(()=>null))?.choices?.[0]?.message?.content?.trim();if(!o)throw new Error("\u8FD4\u56DE\u4E3A\u7A7A");return I(o,t)},_setAiStatus(t,e="info"){let s=this._root?.querySelector("#ai-status");if(s){if(!t){s.textContent="\u70B9\u4EFB\u610F\u4E00\u884C\u5373\u53EF\u4ECE\u90A3\u91CC\u5F00\u59CB\u6717\u8BFB",s.className="text-xs text-slate-500";return}s.textContent=t,s.className="text-xs "+(e==="ok"?"text-green-600 dark:text-green-400":e==="err"?"text-red-600 dark:text-red-400":"text-slate-500")}},_openSaveDialog(){if(!this._text||!this._text.trim()){this._setAiStatus("\u6CA1\u6709\u53EF\u4FDD\u5B58\u7684\u6587\u672C","err");return}let t=this._root.querySelector("#save-dlg"),e=this._root.querySelector("#save-title"),s=this._root.querySelector("#save-stats"),a=this._root.querySelector("#save-error");e.value=_(this._text,32),s.textContent=`${this._text.length} \u5B57 \xB7 ${this._segments.length} \u6BB5 \xB7 \u987A\u5E8F\u81EA\u52A8\u64AD\u653E: ${this._root.querySelector("#auto-all").checked?"\u5F00":"\u5173"}`,a.classList.add("hidden"),a.textContent="",t.showModal(),setTimeout(()=>{e.focus(),e.select()},0)},_closeSaveDialog(){this._root.querySelector("#save-dlg").close()},async _confirmSaveFile(){let t=this._root.querySelector("#save-title"),e=this._root.querySelector("#save-error"),s=i=>{i?(e.textContent=i,e.classList.remove("hidden")):(e.classList.add("hidden"),e.textContent="")},a=t.value.trim();if(!a){s("\u6807\u9898\u4E0D\u80FD\u4E3A\u7A7A");return}s("");let l=Date.now(),n=this._root.querySelector("#auto-all").checked===!0,r={id:b("fl"),folderId:null,title:a,text:this._text,segments:Array.isArray(this._segments)?this._segments:[],autoAll:n,createdAt:l,updatedAt:l};try{await y.put(r),this._closeSaveDialog(),this._toast(`\u5DF2\u4FDD\u5B58\u300C${a}\u300D`,"ok"),p.emit("files:save-current",{text:r.text,segments:r.segments,autoAll:r.autoAll,suggestedTitle:r.title})}catch(i){console.error("[speak] save file failed:",i),s("\u4FDD\u5B58\u5931\u8D25:"+(i?.message||i))}},_toast(t,e="info"){let s=document.getElementById("__speak-toast");s||(s=document.createElement("div"),s.id="__speak-toast",s.style.transition="opacity 300ms",document.body.appendChild(s)),s.textContent=t,s.className="fixed bottom-16 left-1/2 -translate-x-1/2 z-50 px-4 py-2 rounded-md shadow-lg text-sm "+(e==="ok"?"bg-green-600 text-white":e==="err"?"bg-red-600 text-white":"bg-slate-800 text-white"),s.style.opacity="1",clearTimeout(this._toastTimer),this._toastTimer=setTimeout(()=>{s.style.opacity="0",setTimeout(()=>{try{s.remove()}catch{}},320)},2e3)},unmount(){this._userStopped=!0,u.stop(),this._unsubPlayerCmd?.(),this._unsubFilesLoaded?.(),this._root=null}};function w(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function A(t){let e=String(t||"");return/[一-鿿぀-ゟ゠-ヿ가-힯]/.test(e)?"zh":"en"}function I(t,e){let a=[t.match(/```(?:json)?\s*([\s\S]*?)```/i)?.[1],t];for(let n of a)if(n)try{let r=JSON.parse(n.trim());if(Array.isArray(r))return r.filter(i=>typeof i=="string"&&i.trim());if(r&&Array.isArray(r.segments))return r.segments.filter(i=>typeof i=="string"&&i.trim())}catch{}let l=t.split(/\r?\n/).map(n=>n.trim()).filter(n=>n&&!n.startsWith("{")&&!n.startsWith("["));return l.length>=2?l:g.split(e)}var C=S;export{C as default,S as page};
